          ...
          <div className="space-y-8 animate-fadeInUp">
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-white font-semibold">Ondersteuning binnen 48 uur</div>
                  <div className="text-slate-400 text-sm">Telefonisch of online, zelf melden of wij signaleren het proactief. Indien nodig komen we op locatie</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 bg-cyan-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
