...
export async function POST(req: NextRequest) {
  ...
  let parsed: { planName?: string; billingCycle?: string; quantity?: number; customerEmail?: string; companyName?: string; kvkNumber?: string; customerName?: string };
  try {
  ...
  const pricingplans = {
    ...
    Compleet: { monthly: 49.95 },
    Premium: { monthly: 99.95 },
  };
